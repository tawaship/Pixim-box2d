...
import { Container, Task } from '@tawaship/pixim.js';
import { Common, Dynamics, Collision } from '@tawaship/box2dweb-module';
export * from '@tawaship/box2dweb-module';
import { Container as Container$1 } from 'pixi.js';

/**
 * @ignore
 */
var Vec2 = Common.Math.b2Vec2; // eslint-disable-line @typescript-eslint/no-unused-vars
/**
 * @ignore
 */
var DebugDraw = Dynamics.b2DebugDraw; // eslint-disable-line @typescript-eslint/no-unused-vars
/**
 * @ignore
 */
var World = Dynamics.b2World; // eslint-disable-line @typescript-eslint/no-unused-vars
/**
 * @ignore
 */
var Contact = Dynamics.Contacts.b2Contact; // eslint-disable-line @typescript-eslint/no-unused-vars
/**
 * @ignore
 */
var ContactListener = Dynamics.b2ContactListener; // eslint-disable-line @typescript-eslint/no-unused-vars
/**
 * @ignore
 */
var BodyDef = Dynamics.b2BodyDef; // eslint-disable-line @typescript-eslint/no-unused-vars
/**
 * @ignore
 */
var FixtureDef = Dynamics.b2FixtureDef; // eslint-disable-line @typescript-eslint/no-unused-vars
/**
 * @ignore
 */
var Body = Dynamics.b2Body; // eslint-disable-line @typescript-eslint/no-unused-vars
/**
 * @ignore
 */
var CircleShape = Collision.Shapes.b2CircleShape; // eslint-disable-line @typescript-eslint/no-unused-vars
/**
 * @ignore
 */
var PolygonShape = Collision.Shapes.b2PolygonShape; // eslint-disable-line @typescript-eslint/no-unused-vars
/**
 * @ignore
 */
var EdgeShape = Collision.Shapes.b2EdgeShape; // eslint-disable-line @typescript-eslint/no-unused-vars
...
class Circle extends Box2dObject {
    ...
    static from(pixi, options = {}) {
        ...
        const c = b2d.addChild(new Container$1());
        c.addChild(pixi);
...
export { Box2dObject, Circle, Edge, Polygon, Rectangle, WorldContainer };
//# sourceMappingURL=Pixim-box2d.esm.js.map
