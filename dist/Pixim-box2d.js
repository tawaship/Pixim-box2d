 ...
 * @license MIT
 */
this.Pixim = this.Pixim || {}, function(exports, pixim_js, box2dwebModule, pixi_js) {
    "use strict";
    ...
    var WorldContainer = function(Container) {
        ...
        }, WorldContainer.prototype.updateTask = function(e) {
            Container.prototype.updateTask.call(this, e);
            var task = this._box2dData.task;
